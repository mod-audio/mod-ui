...
class Host(object):
    ...
    def midi_port_appeared(self, name, isOutput):
        ...
        for i in range(len(self.midiports)):
            port_symbol, port_alias = self.midiports[i]
    ...
    def report_current_state(self, websocket):
        ...
        midiports = []
        for port_id, port_alias in self.midiports:
            if ";" in port_id:
    ...
    def load(self, bundlepath, isDefault=False):
        ...
        curmidisymbols = []
        for port_symbol, port_alias in self.midiports:
            if ";" in port_symbol:
