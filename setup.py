...
setup(name = 'mod',
      ...
      data_files=[  (('share/mod/default.pedalboard'), glob('default.pedalboard/*')),
                    ...
                    (('share/mod/html/js/lib/t3k'), glob('html/js/lib/t3k/*.js')),
                    (('share/mod/html/js/lib/t3k/logo'), glob('html/js/lib/t3k/logo/*.png')),
                    (('share/mod/html/js/lib/t3k/logo'), glob('html/js/lib/t3k/logo/*.svg')),
                    ...
                    (('share/mod/html/resources'), glob('html/resources/*.png')),
