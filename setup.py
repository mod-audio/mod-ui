...
setup(name = 'mod',
      ...
      data_files=[  (('share/mod/default.pedalboard'), glob('default.pedalboard/*')),
                    ...
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/*.js')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/*.css')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/*.gif')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/fonts/*.eot')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/fonts/*.svg')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/fonts/*.ttf')),
                    (('share/mod/html/js/lib'), glob('html/js/lib/slick/fonts/*.woff')),
