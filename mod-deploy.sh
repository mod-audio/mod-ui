...
ssh ${TARGET} mkdir -p /usr/share/mod/html/css/fontello/{css,font} /usr/share/mod/html/js/{lib/slick,utils}
...
scp html/js/lib/slick/*.css     ${TARGET}:/usr/share/mod/html/js/lib/slick/
